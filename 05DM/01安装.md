...
./dminit path=/dmdata/data PAGE_SIZE=32 EXTENT_SIZE=32 CASE_SENSITIVE=y CHARSET=1 DB_NAME=DMTEST INSTANCE_NAME=DBSERVER PORT_NUM=5236 SYSDBA_PWD='yunJs@12'  SYSAUDITOR_PWD='yunJs@12'
```
...
```shell
cd /home/dmdba/dmdbms/bin
./disql SYSDBA/'"yunJs@12"'@192.168.145.15
```
